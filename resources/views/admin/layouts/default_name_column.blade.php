  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{url('admin/dashboard')}}">Dashboard Admin</a>
      </div>
      <!-- /.navbar-header -->
      <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-user">
            <li><a href="{{url('/')}}"><i class="fa fa-gear fa-fw"></i> return to front</a>
            </li>
            <li class="divider"></li>
            ...
            <ul class="nav nav-second-level">
              ...
              <li>
                <a href="{{url('admin/category')}}">
                  <i class="fa fa-gears"></i> {{ trans("admin/nav.category") }}
                </a>
              </li>
              <li>
                <a href="{{url('admin/service')}}">
                  <i class="fa fa-paper-plane"></i> {{ trans("admin/nav.service") }}
                </a>
              </li>
            </ul>
          </li>
